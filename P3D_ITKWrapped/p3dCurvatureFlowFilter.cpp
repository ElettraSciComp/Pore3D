...
int p3dCurvatureFlowFilter2D_8(   
...
{	
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying curvature flow filter...";		
			wr_log ( str.c_str() );
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - Curvature flow filter applied successfully in ";
...
int p3dCurvatureFlowFilter2D_16(   
...
int p3dCurvatureFlowFilter3D_8(   
	unsigned char* in_rev, 
	unsigned char* out_rev, 
	const int dimx,
	const int dimy, 
...
int p3dCurvatureFlowFilter3D_16(   
	unsigned short* in_rev, 
	unsigned short* out_rev, 
	const int dimx,
	const int dimy, 
