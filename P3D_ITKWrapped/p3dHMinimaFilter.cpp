	...
	)
{
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying H-Minima filtering...";		
			wr_log ( str.c_str() );
                        
                        str  = "\t H-value: ";
			str += _p3dIntToString ( (int) min );		
			str += ".";
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - H-Minima filter applied successfully in ";
