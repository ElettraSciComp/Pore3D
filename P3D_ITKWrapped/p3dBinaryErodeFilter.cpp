	...
	)
{
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying binary erosion 2D...";
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - Binary erosion 2D applied successfully in ";
	...
	)
{
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying binary erosion...";		
			wr_log ( str.c_str() );
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - Binary erosion applied successfully in ";
		str += _p3dTimeToString ( timer.GetMean() );		
		str += ".";
