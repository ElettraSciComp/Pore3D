...
int p3dMinMaxCurvatureFlowFilter2D_8(   
...
{	
	...
	typedef itk::MinMaxCurvatureFlowImageFilter< RealImageType, RealImageType > FilterType;
	FilterType::Pointer filter = FilterType::New();

	typedef FilterType::RadiusValueType RadiusType;
	const RadiusType filterRadius = width / 2;
	...
	filter->SetStencilRadius( filterRadius );
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying min/max curvature flow filter...";		
			wr_log ( str.c_str() );
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - Min/max curvature flow filter applied successfully in ";
...
int p3dMinMaxCurvatureFlowFilter2D_16(   
...
int p3dMinMaxCurvatureFlowFilter3D_8(   
	unsigned char* in_rev, 
	unsigned char* out_rev, 
	const int dimx,
	const int dimy, 
...
int p3dMinMaxCurvatureFlowFilter3D_16(   
	unsigned short* in_rev, 
	unsigned short* out_rev, 
	const int dimx,
	const int dimy, 
