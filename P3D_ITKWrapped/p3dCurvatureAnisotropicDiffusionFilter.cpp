...
int p3dCurvatureAnisotropicDiffusionFilter2D_8(   
...
{	
	...
	try
	{
		...
		if (wr_log != NULL)
		{
			str  = "Pore3D - Applying curvature anisotropic diffusion filter...";		
			wr_log ( str.c_str() );
                        str  = "\tK: ";
	...
	if (wr_log != NULL)
	{
		str  = "Pore3D - Curvature anisotropic diffusion filter applied successfully in ";
...
int p3dCurvatureAnisotropicDiffusionFilter2D_16(   
...
int p3dCurvatureAnisotropicDiffusionFilter3D_8(   
	unsigned char* in_rev, 
	unsigned char* out_rev, 
	const int dimx,
	const int dimy, 
...
int p3dCurvatureAnisotropicDiffusionFilter3D_16(   
	unsigned short* in_rev, 
	unsigned short* out_rev, 
	const int dimx,
	const int dimy, 
