...
int IDL_Load(void)
{
	...
	static IDL_SYSFUN_DEF2 function_addr[] = {
                ...
                // Filters:
                //
                { (IDL_FUN_RET) p3d_idlCurvatureAnisotropicDiffusionFilter, "P3DCURVATUREANISOTROPICDIFFUSIONFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
                { (IDL_FUN_RET) p3d_idlGradientAnisotropicDiffusionFilter, "P3DGRADIENTANISOTROPICDIFFUSIONFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
                { (IDL_FUN_RET) p3d_idlCurvatureFlowFilter, "P3DCURVATUREFLOWFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
                { (IDL_FUN_RET) p3d_idlMinMaxCurvatureFlowFilter, "P3DMINMAXCURVATUREFLOWFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
                
                //
                // Segmentation:
                //
            	{ (IDL_FUN_RET) p3d_idlConfidenceRegionGrowing, "P3DCONFIDENCEREGIONGROWING", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
                { (IDL_FUN_RET) p3d_idlMultipleOtsuThresholding, "P3DMULTIPLEOTSUTHRESHOLDING", 2, 2, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
		//
		// ----Morphology: ----
		//
		{ (IDL_FUN_RET) p3d_idlBinaryDilateFilter, "P3DBINARYDILATEFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },		                
		{ (IDL_FUN_RET) p3d_idlBinaryErodeFilter, "P3DBINARYERODEFILTER", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
		{ (IDL_FUN_RET) p3d_idlWatershedSegmentation, "P3DWATERSHEDSEGMENTATION", 1, 1, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
		{ (IDL_FUN_RET) p3d_idlHMinimaFilter, "P3DHMINIMAFILTER", 2, 2, IDL_SYSFUN_DEF_F_KEYWORDS, 0 },
	};
